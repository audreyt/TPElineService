...
class UpdateSubscriptionContainer
{
    private $todo;
    private $obj,$sdetail , $mid, $did, $result, $authToken;
    ...
    public function set()
    {
        ...
        $this->result = $this->obj->updateSubscriptionContainer($this->mid, $this->did, $this->sdetail, $this->todo);
        return json_encode($this->result);
    }
}
